...
Uri quranAppurl = Uri.parse('https://github.com/Ahmed-Khames2');
...
Future readJson() async {
  final String response = await rootBundle.loadString(
    "assets/json/hafs_smart_v8.json",
  );
...
class AppLightColors {
  ...
  static const Color secondary = Color(0xFF87D1A4);
  static const Color title = Color(0xFF006754);
...
class AppDarkColors {
  ...
  static const Color title = Color(0xFF4ECDC4);
  static const Color text = Color(0xFFFFFFFF);
  static const Color button = Color(0xFF4ECDC4);
}
