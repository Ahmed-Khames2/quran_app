...
المصدر: مسلم 2090:4''',
          repeat: 3),
      ZekrModel(text: ''' سُبْحَانَ اللَّهِ وَبِحَمْدِهِ .

المصدر: مسلم 2071:4''', repeat: 100),
      ZekrModel(
          text:
...
المصدر: صحيح الترغيب والترهيب 273:1 ''',
          repeat: 1),
      ZekrModel(
          text:
...
المصدر: البخاري 4:95، مسلم 4:2071''',
          repeat: 100),
    ],
  ),
  AzkarItem(
...
المصدر: الترمذي 466:5''',
          repeat: 1),
      ZekrModel(
          text:
              ''' اللَّهُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ فِي الدُّنْيَا وَالْآخِرَةِ، اللَّهُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ فِي دِينِي، وَدُنْيَايَ، وَأَهْلِي، وَمَالِي، اللَّهُمَّ اسْتُرْ عَوْرَاتِي، وَآمِنْ رَوْعَاتِي، اللَّهُمَّ احْفَظْنِي مِنْ بَيْنِ يَدَيَّ، وَمِنْ خَلْفِي، وَعَنْ يَمِينِي، وَعَنْ شِمَالِي، وَمِنْ فَوْقِي، وَأَعُوذُ بِعَظَمَتِكَ أَنْ أُغْتَالَ مِنْ تَحْتِيَ.

المصدر: ابن ماجه 2: 332''',
          repeat: 1),
      ZekrModel(
          text:
              ''' اللَّهُمَّ أَنْتَ رَبِّي لَّا إِلَهَ إِلَّا أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِنِعْمَتِكَ عَلَيَّ، وَأَبُوءُ بِذَنْبِي فَاغْفِر لِي فَإِنَّهُ لَا يَغْفِرُ الذُّنُوبَ إِلَّا أَنْتَ.
...
المصدر: الترمذي 3 :187، صحيح ابن حبان 1022''',
          repeat: 3),
      ZekrModel(
          text:
              ''' اللَّهُمَّ عَالِمَ الْغَيْبِ وَالشَّهَادَةِ فَاطِرَ السَّماوَاتِ وَالْأَرْضِ، رَبَّ كُلِّ شَيْءٍ وَمَلِيكَهُ، أَشْهَدُ أَنْ لَا إِلَهَ إِلَّا أَنْتَ، أَعُوذُ بِكَ مِنْ شَرِّ نَفْسِي، وَمِنْ شَرِّ الشَّيْطَانِ وَشِرْكِهِ، وَأَنْ أَقْتَرِفَ عَلَى نَفْسِي سُوءاً أَوْ أَجُرَّهُ إِلَى مُسْلِمٍ.

المصدر: الترمذي 142:3''',
          repeat: 1),
      ZekrModel(
          text:
              ''' بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الَْأرْضِ وَلَا فِي السَّمَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ.
...
المصدر: سورة البقرة - 285:2، 286:2، البخاري 4008، 5009، 5040، 5051؛ مسلم 807، 808''',
        repeat: 1),
    ZekrModel(
        text:
...
المصدر: مسلم 2083:4 ''',
        repeat: 1),
    ZekrModel(text: '''اللَّهُمَّ قِنِي عَذَابَكَ يَوْمَ تَبْعَثُ عِبَادَكَ.

المصدر: أبو داود 311:4 ''', repeat: 1),
    ZekrModel(text: ''' بِاسْمِكَ اللَّهُمَّ أَمُوتُ وَأَحْيَا.

المصدر: البخاري 113:11، مسلم 2083:4''', repeat: 1),
    ZekrModel(
        text:
            ''' سُبْحَانَ اللهِ (33)  الْحَمْدُ لِلهِ  (33)  اللهُ أَكْبَرُ (34)

المصدر: البخاري 3705، 5361، 6318، مسلم 2727، 2728، أبو داود 5062''',
        repeat: 100),
    ZekrModel(
        text:
...
المصدر: البخاري 13:11، مسلم 2081:4 ''',
        repeat: 1),
    ZekrModel(
        text:
...
المصدر: مسلم 2713، الترمذي 3481، ابن ماجه 3831 ''',
        repeat: 1),
  ]),
  AzkarItem(
...
المصدر: البخاري 113:11، مسلم 2083:4 ''',
          repeat: 1),
      ZekrModel(
          text:
...
المصدر: أبو داود 5056، الترمذي 3402، النسائي 3:68''', repeat: 1),
      ZekrModel(
          text:
              '''اللهُ لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ لَا تَأْخُذُهُ سِنَةٌ وَلَا نَوْمٌ لَهُ مَا فِي السَّمَاوَاتِ وَمَا فِي الْأَرْضِ مَنْ ذَا الَّذِي يَشْفَعُ عِنْدَهُ إِلَّا بِإِذْنِهِ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ وَلَا يُحِيطُونَ بِشَيْءٍ مِنْ عِلْمِهِ إِلَّا بِمَا شَاءَ وَسِعَ كُرْسِيُّهُ السَّمَاوَاتِ وَالْأَرْضَ وَلَا يَئُودُهُ حِفْظُهُمَا وَهُوَ الْعَلِيُّ الْعَظِيمُ.
...
المصدر: البخاري 181:1، مسلم 419:1 ''',
          repeat: 1),
      ZekrModel(
          text:
              '''سُبْحَانَكَ اللَّهُمَّ وَبِحَمْدِكَ وَتَبَارَكَ اسْمُكَ وَتَعَالَى جَدُّكَ وَلَا إِلَهَ غَيْرُكَ.

المصدر: مسلم 399، النسائي 890، الترمذي 243 ''',
          repeat: 1),
      ZekrModel(
          text:
...
المصدر: مسلم 534:1''',
      ...
      ZekrModel(
          text:
              ''' اللَّهُ أَكْبَرُ كَبِيرَاً، اللَّهُ أَكْبَرُ كَبِيراً، اللَّهُ أَكْبَرُ كَبِيراً، وَالْحَمْدُ لِلَّهِ كَثيراً، وَالْحَمْدُ لِلَّهِ كَثيراً، وَالْحَمْدُ لِلَّهِ كَثيراً، وَسُبْحَانَ اللَّهِ بُكْرَةً وَأَصِيلاً (ثلاثاً) أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ: مِنْ نَفْخِهِ، وَنَفْثِهِ، وَهَمْزِهِ

المصدر: ابو داود 775، الترمذي 242''',
          repeat: 1),
    ],
  ),
  AzkarItem(
...
المصدر: البخاري 202:1، مسلم 412:1''',
          repeat: 1),
      ZekrModel(
          text:
...
المصدر: البخاري 168:8، مسلم 2078:4''',
          repeat: 1),
      ZekrModel(
          text:
...
المصدر: مسلم 534:1 ''',
  ...
  AzkarItem(
    title: 'الدعاء عند الركوع',
    icon: Icons.arrow_downward,
    azkarTexts: [
      ZekrModel(text: '''سُبْحَانَ رَبِّيَ الْعَظِيمِ.

المصدر: الترمذي 83:1 ''', repeat: 3),
      ZekrModel(
          text:
              '''سُبْحَانَكَ اللَّهُمَّ رَبَّنَا وَبِحَمْدِكَ اللَّهُمَّ اغْفِرْ لِي.

المصدر: البخاري 794، 817، 4293، النسائي 1048 ''',
          repeat: 1),
      ZekrModel(text: ''' سُبُّوحٌ، قُدُوسٌ، رَبُّ الْمَلَائِكَةِ وَالرُّوحِ.

المصدر: أبو داود 872، النسائي 1049''', repeat: 1),
      ZekrModel(
          text:
...
المصدر: النسائي 1133 ''',
  ...
  AzkarItem(
    title: "الدعاء عند السجود",
    icon: Icons.bed,
    azkarTexts: [
      ZekrModel(text: '''سُبْحَانَ رَبِّيَ الأَعْلَى.
...
المصدر: أبو داود 879، ابن ماجة 3841''',
          repeat: 1),
    ],
  ),
  AzkarItem(
...
المصدر: البخاري 152:1 ''',
  ...
  AzkarItem(
    ...
    azkarTexts: [
      ZekrModel(text: '''رَبِّ اغْفِرْ لِي رَبِّ اغْفِرْ لِي.

المصدر: النسائي 1146، 1666، أبو داود 874 ''', repeat: 1),
      ZekrModel(
          text:
              ''' اللَّهُمَّ اغْفِرْ لِي، وَارْحَمْنِي، وَاهْدِنِي، وَاجْبُرْنِي، وَعَافِنِي، وَارْزُقْنِي، وَارْفَعْنِي

المصدر: ابن ماجة 3845، 1517، الترمذي 284''',
          repeat: 1),
    ],
  ),
  AzkarItem(
...
المصدر: مسلم: 494:1، ابن ماجة 129:1 ''',
          repeat: 1),
    ],
  ),
  AzkarItem(
...
المصدر: أبوداود رقم 101، إبن ماجة رقم 397 ''', repeat: 1),
    ],
  ),
  AzkarItem(
    title: ' الذكر بعد الانتهاء من الوضوء',
...
المصدر: ابو داود 4023، الترمذي 3458، ابن ماجه 3285''',
          repeat: 1),
      ZekrModel(
          text:
...
المصدر: البخاري 5458، أبو داود 3849، الترمذي 3456 ''',
          repeat: 1),
    ],
  ),
  AzkarItem(
    title: 'قبل الطعام والشراب',
    icon: Icons.fastfood,
    azkarTexts: [
      ZekrModel(
          text: ''' بِسْمِ اللهِ.

المصدر: البخاري 5367، 5378، مسلم 2022، أبو داود 3767، الترمذي 1858''',
          repeat: 1),
    ],
  ),
  AzkarItem(
...
المصدر: الترمذي رقم 1767، أبو داود رقم 4020 ''',
          repeat: 1),
    ],
  ),
  AzkarItem(
...
المصدر: الترمذی رقم 3458، أبو داود رقم 4023 ''',
          repeat: 1),
    ],
  ),
  AzkarItem(
...
المصدر: البخاري 1:45، مسلم 1:283''', repeat: 1),
    ],
  ),
  AzkarItem(
